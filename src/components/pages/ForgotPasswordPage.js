        ...
        <div className="max-w-md w-full mx-auto mt-4 bg-white p-8 border border-gray-300">
          <form action="" className="space-y-6">
            <div className="max-w-md w-full mx-auto">
              <div className="text-center text-3xl font-bold">FORGOT YOUR PASSWORD</div>
              <div className="text-center text-m font-bold">Please enter your email address below to receive a password reset link</div>
            </div>
            <div>
              <label
                htmlFor=""
                className="text-sm font-bold text-gray-600 block" required
              >
                Email
              </label>
              <input
